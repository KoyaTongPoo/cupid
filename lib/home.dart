...
import 'package:cupid/tabs/notifications_screen.dart';
// import 'package:gallery/studies/rally/tabs/overview.dart';
import 'package:cupid/tabs/profile_screen.dart';
// import 'package:gallery/studies/rally/tabs/settings.dart';
// import 'package:gallery/studies/rally/tabs/test.dart';
// import 'package:gallery/studies/rally/tabs/test2.dart';
...
class _HomePageState extends State<HomePage>
  ...
  Widget build(BuildContext context) {
    ...
    if (isDesktop) {
      ...
      //     isTextDirectionRtl ? 3 : 1;
      // final revertVerticalRotation =
      //     isTextDirectionRtl ? 1 : 3;
      tabBarView = Row(
        children: [
          Container(
  ...
  List<Widget> _buildTabs(
    ...
    return [
      ...
      //   title: GalleryLocalizations.of(context)!.testTabTitle,
      //   tabIndex: 5,
      //   tabController: _tabController!,
      //   isVertical: isVertical,
      // ),
